    ...
    BUS: Write + WriteRead,
{
        ...
        R: Register + Readable,
    {
        ...
        self.0
            .bus
            .write_read(I2C_ADDRESS, &buf, &mut buffer)
    ...
    BUS: I2c,
{
        ...
        [(); R::LEN]: Sized,
    {
        ...
        self.0
            .bus
            .write_read(I2C_ADDRESS, &buf, buffer)
            .await
            .map_err(Error::Transfer)?;


        defmt::trace!("Read: {:#x}", buffer);
...
/// An I2C error that can occur when communicating with the LSM6DSO
#[cfg(not(feature = "async"))]
pub enum Error<I2C>
where
    I2C: Write + WriteRead,
{
    /// I2C error occured during a transfer transaction
    Transfer(I2C::Error),
}
...
/// Initializes the I2C message header
///
/// Initializes the I2C message header for accessing a given register, writing
